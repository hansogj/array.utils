...
describe('defined', () => {
  ...
  describe.each([{}, [1, 2, 3], 'tekstlig innhold', true, 0, 1])(
    'defined of %p ',
    (cond: any) => {
  ...
  describe.each([
    ...
    { a: [] },
    { a: false },
  ])('defined of object %p', (cond: any) => {
    it('forventer definerte egenskaper', () =>
      expect(defined(cond.a)).toBeFalsy());
  });
  ...
  describe.each([
    ...
    it('forventer definerte egenskaper', () =>
      expect(defined(cond.a)).toBeTruthy());
  });

  describe.each([function () {}, () => {}])(
    'defined of function of %p ',
    (cond: any) => {
